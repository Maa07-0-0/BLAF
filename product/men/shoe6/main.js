...
document.addEventListener('DOMContentLoaded', () => {
  const start = async () => {
    ...
    const mindarThree = new window.MINDAR.IMAGE.MindARThree({
      ...
      imageTargetSrc: 'assets/targets/men/men6.mind'
    });
    ...
    const men1 = await loadGLTF('assets/models/men6/scene.gltf');
    ...
    const audioClip = await loadAudio('assets/sounds/shoe6.mp3');
