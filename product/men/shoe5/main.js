...
document.addEventListener('DOMContentLoaded', () => {
  const start = async () => {
    ...
    const mindarThree = new window.MINDAR.IMAGE.MindARThree({
      ...
      imageTargetSrc: 'assets/targets/men/men5.mind'
    });
    ...
    const men1 = await loadGLTF('assets/models/men5/scene.gltf');
    ...
    const audioClip = await loadAudio('assets/sounds/shoe5.mp3');
