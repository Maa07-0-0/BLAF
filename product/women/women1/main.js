...
document.addEventListener('DOMContentLoaded', () => {
  const start = async () => {
    ...
    const mindarThree = new window.MINDAR.IMAGE.MindARThree({
      ...
      imageTargetSrc: 'assets/targets/women/women1.mind'
    });
    ...
    const men1 = await loadGLTF('assets/models/women1/scene.gltf');
    men1.scene.scale.set(0.03, 0.03, 0.03);
    ...
    const audioClip = await loadAudio('assets/sounds/women1.mp3');
    ...
    renderer.setAnimationLoop(() => {
      ...
      men1.scene.rotation.y += 0.01; // Adjust the rotation speed as desired
